  ...
  const globalKeys = [
    ...
    { key: 'reward_raffle_max', label: 'Reward: Raffle Max', type: 'number', def: 25000, tooltip: 'Maxsimum points won in a random  raffle trigged by subbing/resubbing/gifting subs and gifting bits' },
    { key: 'reward_multiraffle_min', label: 'Reward: Multi-Raffle Min', type: 'number', def: 3, tooltip: 'Minimum winners in a random multi-raffle trigged by subbing/resubbing/gifting subs' },
    { key: 'reward_multiraffle_max', label: 'Reward: Multi-Raffle Max', type: 'number', def: 12, tooltip: 'Maximum winners in a random multi-raffle trigged by subbing/resubbing/gifting subs' },
